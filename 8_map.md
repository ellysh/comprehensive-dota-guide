...
Река разделяет карту на стороны Сил Света и Сил Тьмы. Реку можно пересечь, но зайти в неё можно только по лестницам (рампы, ramps).

![Лестницы](images/8.2_ramps.png)
...
Обзор героя внизу лестницы, наверху и на утёсе (cliff):

![Обзор на лестнице](images/8.3_ramp_vision.gif)
...
* Если Aegis не был использован в течение 5 минут с момента его поднятия героем, предмет исчезает, а герой полностью восстанавливает своё здоровье в течение 5 секунд. Процесс восстановления прерывается при получении урона от других игроков или строений.
